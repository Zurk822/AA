...
public class Calculador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rejilla = new javax.swing.JLabel();
        ...
        rejilla.setBackground(new java.awt.Color(255, 255, 255));
        rejilla.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        rejilla.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true));
        rejilla.setOpaque(true);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(rejilla, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rejilla, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.primernumero=Float.parseFloat(this.rejilla.getText());
        this.operador="*";
        this.rejilla.setText("");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"7");
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"8");
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"9");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"4");
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"5");
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"6");
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"1");
    }//GEN-LAST:event_jButton15ActionPerformed

    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"2");
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"3");
    }//GEN-LAST:event_jButton17ActionPerformed

    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        this.segundonumero=Float.parseFloat(this.rejilla.getText());
        
        switch(this.operador){
            case "+":this.rejilla.setText(sincero(this.primernumero+this.segundonumero));
            break;
            case "-":this.rejilla.setText(sincero(this.primernumero-this.segundonumero));
            break;
            case "*":this.rejilla.setText(sincero(this.primernumero*this.segundonumero));
            ...
            case "/":if(this.segundonumero==0){
                this.rejilla.setText("Syntax Error");
                break;
            }else{
                this.rejilla.setText(sincero(this.primernumero/this.segundonumero));
                break;
            }  
            case "^":
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        this.rejilla.setText(this.rejilla.getText()+"0");
    }//GEN-LAST:event_jButton19ActionPerformed

    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        if (!(this.rejilla.getText().contains("."))){
            this.rejilla.setText(this.rejilla.getText()+".");
        }
    ...
    private javax.swing.JLabel rejilla;
